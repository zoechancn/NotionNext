const CONFIG = {
  ...
  SITE_CREATE_TIME: '2023-08-17', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
  NOTICE_BAR: [
    { title: '欢迎来到我的博客', url: 'https://blog.zoeserver.top' },
  ],

  // 英雄区(首页顶部大卡)
  HERO_TITLE_1: 'unRaid',
  HERO_TITLE_2: '教程&资讯',
  HERO_TITLE_3: 'blog.zoeserver.top',
  HERO_TITLE_4: 'welcome to my Blog',
  HERO_TITLE_5: '自媒体与网络部署',
  HERO_TITLE_LINK: 'blog.zoeserver.top',
